...
export async function GET(request: NextRequest) {
  try {
    const dbProducts = await query('SELECT id, name, code, reference, barcode, stock, category, brand, minstock, maxstock, cost, price, imageurl, dataaihint, createdat, updatedat FROM Products ORDER BY name ASC');
...
export async function POST(request: NextRequest) {
  try {
    ...
    // The 'id' column is SERIAL and will be auto-generated by PostgreSQL.
    // 'createdat' and 'updatedat' columns will use their DEFAULT CURRENT_TIMESTAMP values on insert.
    const sql = `
